...
- [责任链（Chain Of Responsibility）](./chainresponsibility/README.md)
- [命令（Command）](./command/README.md)
- [解释器（Interpreter）](./interpreter/README.md)
...
- [模板方法（Template Method）](./templatemethod/README.md)
- [访问者（Visitor）](./visitor/README.md)
- [空对象（Null）](./nullobject/README.md)
